    ...
    <div className="bg-white shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
        <div className="flex justify-between items-center h-16 sm:h-18 md:h-20">
            ...
            <Link to="/" className="flex items-center space-x-2 sm:space-x-3 no-underline">
              <div className="relative group flex-shrink-0">
                <svg
                  ...
                  height="60"
                  viewBox="0 0 150 150"
                  className="sm:w-[70px] sm:h-[70px] md:w-[80px] md:h-[80px] lg:w-[90px] lg:h-[90px] drop-shadow-lg hover:drop-shadow-xl transition-all duration-500 hover:scale-105"
              ...
              <div className="flex flex-col items-start justify-center flex-shrink-0 min-w-0">
                <span className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-yellow-500 via-green-600 to-emerald-500 bg-clip-text text-transparent whitespace-nowrap">
                  Expensia
                </span>
                <span className="text-xs sm:text-xs text-gray-500 tracking-wide whitespace-nowrap hidden sm:block">
          ...
          {/* Auth Section - Desktop and Tablet */}
              ...
              <div className="flex items-center space-x-3">
                ...
                <Link to="/login">
                  <div className="group relative cursor-pointer">
                    <div className="relative w-12 h-12 lg:w-14 lg:h-14 bg-gradient-to-br from-emerald-400/20 via-red-500/30 to-cyan-600/20 backdrop-blur-sm border border-white/30 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 flex items-center justify-center overflow-hidden hover:scale-105">
                      ...
                      <div className="absolute top-2 right-2 w-2 h-2 lg:w-3 lg:h-3 bg-gradient-to-br from-white/60 to-emerald-300/40 rounded-full blur-[1px] animate-pulse"></div>
                      <div className="absolute bottom-2 left-2 lg:bottom-3 lg:left-3 w-1.5 h-1.5 lg:w-2 lg:h-2 bg-gradient-to-br from-cyan-300/50 to-white/30 rounded-full blur-[0.5px]"></div>
                      ...
                      <svg 
                        ...
                        viewBox="0 0 24 24" 
                        fill="none" 
                        className="lg:w-7 lg:h-7 relative z-10 text-red-800 drop-shadow-sm group-hover:text-red-600 transition-colors duration-300"
                      >
                        {/* Key body */}
                        <circle 
                          cx="9" 
                    ...
                    <div className="hidden lg:block absolute -bottom-12 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-gray-800 to-gray-900 text-white text-sm px-4 py-2 rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-300 whitespace-nowrap shadow-xl backdrop-blur-sm border border-gray-700/50">
                ...
                {/* Register Button */}
                <Link to="/register">
                  <button className="px-4 py-2 lg:px-6 lg:py-2.5 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-green-600 rounded-lg hover:from-green-600 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 whitespace-nowrap shadow-sm">
                    Register
                  </button>
                </Link>
              </div>
          ...
          {/* Mobile and Small Tablet Auth Section */}
          <div className="md:hidden flex items-center flex-shrink-0 ml-2">
            {isAuthenticated ? (
              <div className="relative" ref={dropdownRef}>
                <button
                  onClick={toggleDropdown}
                  className="flex items-center p-1.5 rounded-full hover:bg-gray-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-500"
                >
                  <div className="w-8 h-8 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full flex items-center justify-center text-white font-semibold text-sm ring-2 ring-green-500 ring-offset-2 ring-offset-white">
                    {user?.name ? user.name.charAt(0).toUpperCase() : 'U'}
                  </div>
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl ring-1 ring-black ring-opacity-5 z-50 border border-gray-100">
                    <div className="py-2">
              ...
              <Link to="/login">
                <div className="group relative cursor-pointer">
                  <div className="relative w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-emerald-400/20 via-red-500/30 to-cyan-600/20 backdrop-blur-sm border border-white/30 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 flex items-center justify-center overflow-hidden hover:scale-105">
                    {/* Glass morphism background layers */}
